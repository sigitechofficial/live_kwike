            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="header text-center">
                        ...
                        <p class="lead">Login to your account - Retailer</p>
                    </div>
                    <div class="body">
                        <form class="form-auth-small" action="{{route('retailer/login/check')}}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="signin-email" class="control-label sr-only">Email</label>
                                <input type="email" class="form-control" id="signin-email" value="retailer@retailer.com" name="email" placeholder="Email">
                            </div>
                            <div class="form-group">
