        ...
        <div class="main-wrapper">
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-md-4 col-lg-4">
                                    <label for="formFile" class="form-label">Restaurants</label>
                                    <select class="form-select shadow-sm" id="autoSizingSelect">
                                        <option  selected>Mei Kong</option>
                                        <option value="2">Burger King</option>
                                        <option value="3">Yasir Broast</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mt-5">
                                <div class="col-12">
                                    <div style="float: right;">
                                        <button class="btn btn-primary shadow" type="submit">Edit Coupon</button>
                ...
                <div class="col-md-4 col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            <img class="img-fluid" src="assets/images/coupons.jpg">
                        </div>
