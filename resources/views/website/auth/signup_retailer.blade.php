                            ...
                            <div class="card">
                              ...
                              <div class="row g-0">
                                ...
                                <div class="col-md-8 col-lg-8 d-flex align-items-center right_side_neuro">
									<form action="{{route('signup.retailer.store')}}" method="post" enctype="multipart/form-data" style="width: inherit;">
										@csrf
										<div class="card-body p-3 p-lg-4 text-black">
											<div class="d-flex align-items-center mb-3 pb-1">
												...
												<span class="h4 fw-bold mb-0" style="color: #ff6219;">Signup as Retailer</span>
											</div>
											<hr>
											...
											<div class="row">
												<div class="col-12 col-md-6 col-lg-6">
													<div class="form-outline mb-2">
														...
														<input type="file" name="profile_image"  class="form-control form-control-lg dropify">
													</div>
												</div>   
											</div>
											<div class="row">
											...
											<div class="form-outline mb-2">
												...
												<input type="text"  name="store_mobile" class="form-control form-control-lg">
											</div>
											<div class="form-outline mb-2">
											...
											<div class="form-outline mb-2">
												...
												<input type="file"  name="image_url" class="form-control form-control-lg">
											</div>
											<div class="form-outline mb-2">
												<div class="mt-5" id='map' style="width:auto;height:300px;"></div>
											</div>
											<div class="form-outline mb-2">
												<label class="form-label">Address</label>
												<input type="text"  name="store_address" id="address"  class="form-control form-control-lg">
											</div>
											<div class="form-outline mb-2">
												<label class="form-label">Latitude</label>
												<input type="text"  name="latitude" id="lat"  class="form-control form-control-lg">
											</div>
											<div class="form-outline mb-2">
												<label class="form-label">Longitude</label>
												<input type="text"  name="longitude" id="lang"  class="form-control form-control-lg">
											</div>
											<div class="form-outline mb-2">
												<label class="form-label">Zip Code</label>
												<input type="text"  name="zip_code" id="zip"  class="form-control form-control-lg">
											</div>
											<div class="form-outline mb-2">
												<label class="form-label">Opening Vlosing Time</label>
												<input type="text"  name="opening_Closing_time" class="form-control form-control-lg">
											</div>
											<div class="form-outline mb-2">
