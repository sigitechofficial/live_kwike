                                ...
                                <div class="col-md-8 col-lg-8 d-flex align-items-center right_side_neuro">
                                    <div class="card-body p-3 p-lg-4 text-black">
                                        ...
                                        <div class="form-outline mb-2">
                                            ...
                                            <input type="text" name="vehicle_no" class="form-control form-control-lg" required>
                                        </div>
                                        <div class="form-outline mb-2">
                                            <label class="form-label">Vehicle Company*</label>
                                            <input type="password" name="vehicle_company" class="form-control form-control-lg" required>
                                        </div>
                                        <div class="row">
                                            <div class="col-12 col-md-6 col-lg-6">
                                                <div class="form-outline mb-2">
                                                    <label class="form-label">License Front Image</label>
                                                    <input type="file"  class="form-control form-control-lg dropify">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6 col-lg-6">
                                                <div class="form-outline mb-2">
